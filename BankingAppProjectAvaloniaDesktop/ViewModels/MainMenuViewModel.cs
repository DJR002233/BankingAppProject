...
public class MainMenuViewModel : ViewModelBase
{
    ...
    public AsyncRelayCommand GoToTransactionFormViewCommand { get; }
    #endregion Commands
    #region Fields
    ...
    public MainMenuViewModel(NavigationService navigation, BankAccountService bankAccountService, Func<string, decimal, TransactionFormViewModel> transactionFormVM, Func<LoginViewModel> loginVM)
    {
        ...
        _loginVM = loginVM;
        GoToLoginViewCommand = new AsyncRelayCommand(
            async _ =>
            {
        ...
        GoToTransactionFormViewCommand = new AsyncRelayCommand(
